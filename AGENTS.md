...
- Workspace ID: `262bdd3d-c1e4-4265-849e-20a3361febbd`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/262bdd3d-c1e4-4265-849e-20a3361febbd.
...
2. `npx ngodingpakeai connect --workspace 262bdd3d-c1e4-4265-849e-20a3361febbd --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/262bdd3d-c1e4-4265-849e-20a3361febbd. Only pass on links the CLI actually printed — never assemble one from an id yourself.
