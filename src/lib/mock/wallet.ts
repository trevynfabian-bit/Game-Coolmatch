...
export const MOCK_COIN_ENTRIES: CoinEntry[] = [
  ...
  },
  {
    ...
    amount: 150,
    reason: "hasil-match",
    note: "Menang di Lorong Pabrik",
  },
  { id: "koin-16", at: jam(12, 20, 16), amount: 70, reason: "bonus-kill" },
  {
    id: "koin-17",
    at: jam(11, 21, 20),
    amount: 130,
    reason: "hasil-match",
    note: "Kalah di Atap Kota",
  },
  { id: "koin-18", at: jam(11, 21, 21), amount: 55, reason: "bonus-kill" },
  { id: "koin-19", at: jam(11, 21, 22), amount: 30, reason: "bonus-ronde" },
  {
    id: "koin-20",
    at: jam(9, 19, 45),
    amount: -220,
    reason: "belanja-upgrade",
    note: "Peredam untuk P9 Ringkas",
  },
  {
    id: "koin-21",
    at: jam(8, 22, 0),
  ...
  { id: "koin-22", at: jam(8, 22, 1), amount: 105, reason: "bonus-kill" },
  { id: "koin-23", at: jam(8, 22, 2), amount: 60, reason: "bonus-ronde" },
  {
    id: "koin-24",
    at: jam(7, 20, 50),
    amount: -180,
    reason: "belanja-skin",
    note: "Skin Baja Tua untuk Vektor Cepat",
  },
  {
    id: "koin-12",
    at: jam(0, 21, 5),
