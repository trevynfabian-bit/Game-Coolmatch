...
const DASAR: ViewmodelClips = {
  ...
  reload: { drop: 0.3, tilt: 0.55, easeIn: 0.18, easeOut: 0.22 },
...
export const MOCK_VIEWMODEL_CLIPS: Record<WeaponType, ViewmodelClips> = {
  pistol: {
    ...
    reload: { drop: 0.26, tilt: 0.5, easeIn: 0.2, easeOut: 0.24 },
  },
  ...
  smg: {
    ...
    reload: { drop: 0.28, tilt: 0.52, easeIn: 0.18, easeOut: 0.22 },
  },
  rifle: {
    ...DASAR,
  ...
  shotgun: {
    ...
    reload: { drop: 0.42, tilt: 0.7, easeIn: 0.12, easeOut: 0.16 },
  },
  sniper: {
    ...DASAR,
    ...
    reload: { drop: 0.4, tilt: 0.68, easeIn: 0.12, easeOut: 0.18 },
  },
};
